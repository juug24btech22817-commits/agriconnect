            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <header className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-6">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-3 bg-gray-50 dark:bg-gray-800/50 p-3 rounded-xl border border-gray-100 dark:border-gray-800 inline-block shadow-sm">
                           💡 <strong>Quick tip:</strong> Keep your latest listings fresh and review buyer activity before noon for better sales!
                        </p>
                    </div>
